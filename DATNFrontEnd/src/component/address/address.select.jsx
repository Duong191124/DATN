...
const AddressModal = ({
  ...
  const defaultOption = {
    ...
    DistrictID: "",
    WardCode: "",
    ProvinceName: t("MES-024"),
    DistrictName: t("MES-027"),
    WardName: t("MES-030"),
  };
  ...
  useEffect(() => {
    if (editingAddress) {
      const { name, phoneNumber, city, district, ward, addressDetail } =
        editingAddress;
      form.setFieldsValue({
        name,
        phone: phoneNumber,
      ...
      <Form form={form} layout="vertical" onFinish={onFormSubmit}>
        ...
        >
          <Select
            ...
            onChange={(value) => {
              const provinceName =
                provinces.find((p) => p.ProvinceID === value)?.ProvinceName ||
                "";
        ...
        {wards.length > 0 && (
          ...
          >
            <Select
              ...
              onChange={(value) => {
                const wardName =
                  wards.find((w) => w.WardCode === value)?.WardName || "";
